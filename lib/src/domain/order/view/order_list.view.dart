                      ...
                      child: Column(
                        children: [
                          ...
                          orderController.totalBalanceList.isNotEmpty ?
                            ...
                            child: SizedBox(
                              width: Get.width,
                              height: isDesktop ? Get.height * 0.32 : Get
                                  .height * 0.31,
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var totalBalance = orderController
                                      .totalBalanceList[index];
                                    if (orderController.stateBalance.value ==
                                        PageState.loading) {
                                      //   EasyLoading.show(status: 'دریافت اطلاعات از سرور...');
                                      return Center(child: CircularProgressIndicator());
                                    }else if (orderController.stateBalance.value ==
                                        PageState.empty) {
                                      //  EasyLoading.dismiss();
                                      return EmptyPage(
                              ...
                              return
                                              ...
                                              children: [
                                                SingleChildScrollView(
                                                  child: Column(
                                                    children: [
                                                      DataTable(
                                                        sortColumnIndex: orderController
                                                            .sortColumnIndex
                                                            .value,
                                                        sortAscending: orderController
                                                            .sortAscending
                                                            .value,
                                ...
                                SizedBox(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemCount: orderController.orderList
                                        .length +
                ...
                Column(
                  ...
                  children: [
                    ...
                    funcOrderDetail('', 'مقدار سفارش:',
                      "${orders.quantity?.toString() ?? "0"} ${orders.item
                          ?.itemUnit?.name ?? ""}",
                    ),
                    SizedBox(height: 3,),
                    funcOrderDetail(
                      ...
                      'قیمت (مثقال):',
                      (orders.mesghalPrice != null)
                          ? "${orders.mesghalPrice?.toInt().toString().seRagham(
                          separator: ',')} ریال"
                          : "0",
                    ...
                    funcOrderDetail(
                      ...
                      'قیمت (ریال):',
                      (orders.price != null)
                          ? "${orders.price?.toInt().toString().seRagham(
                          separator: ',')} ریال"
                          : "0",
                    ...
                    funcOrderDetail(
                      ...
                      (orders.totalPrice != null)
                          ? "${orders.totalPrice?.toInt().toString().seRagham(
                          separator: ',')} ریال"
                          : "0",
                    ...
                    orders.type == 1
                        ? funcOrderDetail(
                      '', 'نوع سفارش:', "خرید", color: AppColor.secondary2Color,
                    )
                        : funcOrderDetail(
                      '', 'نوع سفارش:', "فروش", color: AppColor.accentColor,
                    )
                  ],
                ),
                Spacer(),
                      ...
                      OutlinedButton(
                        onPressed: () {
                          Get.offAllNamed('/orderUpdate',
                              parameters: {"id": orders.id.toString()});
                        },
                        style: ButtonStyle(
                          shape: WidgetStatePropertyAll(
                            RoundedRectangleBorder(
                        ...
                        style: ButtonStyle(
                            ...
                            shape: WidgetStatePropertyAll(
                                RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(4)))),
                        child: Container(
                          height: 23, width: 25, alignment: Alignment(0, 0),
                          child: Text(
                            'تایید',
                            style: AppTextStyle.bodyText,
